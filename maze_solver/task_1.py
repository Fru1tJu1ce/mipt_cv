...
def find_way_from_maze():
    ...
    # Инициализация картинки, рассчет толщины стены и ширины клетки пути
    test_image = cv2.imread('20_by_20_orthogonal_maze.png')
    wall, void = determine_void_wall_thickness(test_image)

    # Рассчет размеров лабиринта, ввод начальной и конечной точки
    ...
    # Рассчет пути решения лабиринта
